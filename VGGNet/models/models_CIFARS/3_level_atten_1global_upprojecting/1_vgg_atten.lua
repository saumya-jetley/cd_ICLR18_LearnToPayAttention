...
local gfeat_repl1 = nn.Replicate(32,2,1)(gfeat_bn_relu_dp) -- spatial dimension 1 of lfeat 
local gfeat_repl2 = nn.Replicate(32,2,1)(gfeat_repl1) -- spatial dimension 2 of lfeat 

local lfeat_high = nn.SpatialConvolution(256,512,1,1,1,1,0,0)(lfeat)

local glfeat_add = nn.CAddTable()({gfeat_repl2, lfeat_high})
...
local lfeat_reshaped = nn.Reshape(512,1024)(lfeat_high)
