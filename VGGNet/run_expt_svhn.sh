...
#-------------------------------TRAIN-------------------------------------------------------------
# Train svhn-10 (2level_1global_concatDP)
export model_archi_local1='models/models_SVHN/2_level_atten_1globalDP/1.1_vgg_local.lua'
export model_archi_local2='models/models_SVHN/2_level_atten_1globalDP/1.2_vgg_local.lua'
export model_archi_global2='models/models_SVHN/2_level_atten_1globalDP/2.2_vgg_global.lua'
export model_archi_atten1='models/models_SVHN/2_level_atten_1globalDP/3.1_vgg_atten.lua'
export model_archi_atten2='models/models_SVHN/2_level_atten_1globalDP/3.2_vgg_atten.lua'
export model_archi_match='models/models_SVHN/2_level_atten_1globalDP/4_vgg_match.lua'
export dataset='./#dataset/SVHN/svhn_provider.t7'
export num_classes=10
export mode='train'
...
export save='#logs/trials/2_level_atten_1global_svhn_concatDP'
th ./lua_source/main_AttLevel2_1global.lua | tee runtimerecord_concatDP_svhn.txt
END

# Test svhn-10 (2levels-HL-PAN)
export model_archi_local1='models/models_SVHN/2_level_atten_higherlevel_PAN/1.1_vgg_local.lua'
export model_archi_local2='models/models_SVHN/2_level_atten_higherlevel_PAN/1.2_vgg_local.lua'
export model_archi_global1='models/models_SVHN/2_level_atten_higherlevel_PAN/2.1_vgg_global.lua'
export model_archi_global2='models/models_SVHN/2_level_atten_higherlevel_PAN/2.2_vgg_global.lua'
export model_archi_atten1='models/models_SVHN/2_level_atten_higherlevel_PAN/3.1_vgg_atten.lua'
export model_archi_atten2='models/models_SVHN/2_level_atten_higherlevel_PAN/3.2_vgg_atten.lua'
export model_archi_match='models/models_SVHN/2_level_atten_higherlevel_PAN/4_vgg_match.lua'
export dataset='./#dataset/SVHN/svhn_provider.t7'
export num_classes=10
export mode='train'
export batchSize=128
...
export max_epoch=300
export test_batchSize=16
export save='#logs/trials/2_level_atten_1global_hlll_PAN_svhn'
th ./lua_source/main_multiplicativeatt_hl_ll.lua | tee runtimerecord_PAN_svhn.txt
