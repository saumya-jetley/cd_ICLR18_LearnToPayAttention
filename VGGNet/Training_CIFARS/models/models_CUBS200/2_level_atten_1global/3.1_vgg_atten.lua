...
local gfeat_repl1 = nn.Replicate(16,2,1)(gfeat) --8 = spatial dimension 1 of lfeat  --ASS
local gfeat_repl2 = nn.Replicate(16,2,1)(gfeat_repl1) --8 = spatial dimension 2 of lfeat  --ASS
