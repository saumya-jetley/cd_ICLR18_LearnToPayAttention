...
local gfeat_repl1 = nn.Replicate(32,2,1)(gfeat_low) --8 = spatial dimension 1 of lfeat  --ASS
local gfeat_repl2 = nn.Replicate(32,2,1)(gfeat_repl1) --8 = spatial dimension 2 of lfeat  --ASS
