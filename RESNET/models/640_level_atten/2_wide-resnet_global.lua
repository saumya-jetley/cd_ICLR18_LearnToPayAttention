...
local function ConvBNReLU(nInputPlane, nOutputPlane)
  ...
  wrn_conv2:add(nn.SpatialBatchNormalization(nOutputPlane,1e-3))
...
--ConvBNReLU(640,640):add(nn.Dropout(0.4))
--wrn_conv2:add(MaxPooling(2,2,2,2):ceil())
--ConvBNReLU(640,640):add(nn.Dropout(0.4))

wrn_conv2:add(MaxPooling(4,4,4,4):ceil())
ConvBNReLU(640,640):add(nn.Dropout(0.4))

wrn_conv2:add(MaxPooling(2,2,2,2):ceil())
wrn_conv2:add(nn.View(640))

wrn_full3 = nn.Sequential()
wrn_full3:add(nn.Dropout(0.5))
wrn_full3:add(nn.Linear(640,640))
