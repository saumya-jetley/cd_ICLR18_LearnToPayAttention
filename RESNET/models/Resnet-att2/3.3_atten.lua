...
--lfeat = nn.SpatialBatchNormalization(256)(lfeat)
...
local att_mag = nn.SpatialConvolution(256,1,1,1,1,1,0,0)(glfeat_add)  --ASS
...
local att_retrans = nn.Replicate(256,2,1)(att_mag_smax)  --ASS

local lfeat_reshaped = nn.Reshape(256, 64)(lfeat)  --ASS
