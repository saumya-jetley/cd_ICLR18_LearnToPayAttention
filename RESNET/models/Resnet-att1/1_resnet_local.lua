...
local function createModel(opt)
   ...
   do
      ...
      model:add(layer(bottleneck, nStages[3], nStages[4], n-1, 2)) -- Stage 3 (spatial size: 8x8)
      model:add(Convolution(nStages[4],nStages[4],3,3,1,1,1,1)) -- one conv at the end (1 of 3 of (nth)
      model:add(Convolution(nStages[4],nStages[4],3,3,2,2,1,1)) -- two conv at the end (spatial size: 4x4)
--[[
